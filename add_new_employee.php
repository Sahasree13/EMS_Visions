<?php
require 'conn.php';
 session_start();//to encrypt dash.php and make it available when login is done
 if(!$_SESSION['u_name']){
...
<body>
<!--nav-->
<?php require 'nav.php';//connecting the nav.php?>
<!--nav-->
<!--main content-->
<div class="container">
<div class="row">
...
<div class="form-group">
<input type="submit" class="btn btn-sm btn-success" value="Add Employee"class="form-control input-sm"  name="e_add">
</div>
</form>
</div>
</div>
